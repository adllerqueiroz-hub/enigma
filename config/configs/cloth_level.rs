...
pub struct ClothLevel {
    ...
    #[serde(rename = "use")]
    pub r#use: i32,
    #[serde(rename = "useDeviceCard")]
    pub use_device_card: i32,
    #[serde(rename = "usePower1")]
    pub use_power1: Vec<i32>,
    #[serde(rename = "usePower2")]
    pub use_power2: Vec<i32>,
    #[serde(rename = "usePower3")]
    pub use_power3: Option<serde_json::Value>,
    #[serde(rename = "usePower4")]
    pub use_power4: Option<serde_json::Value>,
}
...
impl ClothLevelTable {
    pub fn load(path: &str) -> anyhow::Result<Self> {
        let records: Vec<ClothLevel> = crate::load_rows(path)?;
